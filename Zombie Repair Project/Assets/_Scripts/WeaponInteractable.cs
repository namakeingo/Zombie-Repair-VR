...
/// <summary>
/// Modified version of the SteamVR InteractionSystem for Weapons in the game
/// </summary>
namespace Valve.VR.InteractionSystem
{
    ...
    public class WeaponInteractable : MonoBehaviour
    {
        ...
        private WeaponScaffold weaponFrame;
        ...
        protected virtual void Awake()
        {
            ...
            weaponFrame = GetComponent<WeaponScaffold>();
            var playerHandler = FindObjectOfType<PlayerHandler>();
        ...
        protected virtual void HandAttachedUpdate(Hand hand)
        {
            ...
            if (shootaction.state && shootaction.activeDevice == hand.handType)
            {
                weaponFrame.Shooting();
            }
